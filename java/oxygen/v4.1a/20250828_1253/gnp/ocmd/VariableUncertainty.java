 ...
 *       &lt;sequence&gt;
 *         &lt;element name="value" type="{http://ncei.noaa.gov/oads/a4.1}dimensioned_quantity"/&gt;
...
@XmlType(name = "variable_uncertainty", namespace = "http://ncei.noaa.gov/oads/a4.1", propOrder = {
    "value",
...
public class VariableUncertainty {
    ...
    @XmlElement(name = "uncertainty_description", namespace = "http://ncei.noaa.gov/oads/a4.1")
