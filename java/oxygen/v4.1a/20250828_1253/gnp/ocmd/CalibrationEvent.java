 ...
 *         &lt;element name="location" type="{http://ncei.noaa.gov/oads/a4.1}calibration_location" minOccurs="0"/&gt;
...
@XmlType(name = "calibration_event", namespace = "http://ncei.noaa.gov/oads/a4.1", propOrder = {
    "date",
    "location",
    "description"
})
