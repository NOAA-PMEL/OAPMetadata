...
@XmlType(name = "citation", namespace = "http://ncei.noaa.gov/oads/a4.1", propOrder = {
    "title",
    "authors"
})
public class Citation {
    ...
    @XmlElement(required = true)
    protected Citation.Authors authors;
     ...
     * @return
     *     possible object is
     *     {@link Citation.Authors }
     *     
     */
    public Citation.Authors getAuthors() {
        return authors;
    }
     ...
     *     
     */
    public void setAuthors(Citation.Authors value) {
        this.authors = value;
    }
