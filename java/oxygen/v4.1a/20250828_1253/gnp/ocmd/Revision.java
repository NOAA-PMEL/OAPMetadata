 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://ncei.noaa.gov/oads/a4.1}submission_info"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "revision", namespace = "http://ncei.noaa.gov/oads/a4.1", propOrder = {
    "revisionDescription"
})
    ...
    extends SubmissionInfo
{
    ...
    @XmlElement(name = "revision_description", namespace = "http://ncei.noaa.gov/oads/a4.1", required = true)
