 ...
 *       &lt;sequence&gt;
 *         &lt;element name="submitted_by" type="{http://ncei.noaa.gov/oads/a4.1}person_ref"/&gt;
...
@XmlType(name = "submission_info", namespace = "http://ncei.noaa.gov/oads/a4.1", propOrder = {
    "submittedBy",
    "submissionDate"
})
@XmlSeeAlso({
...
public class SubmissionInfo {
    ...
    @XmlElement(name = "submitted_by", namespace = "http://ncei.noaa.gov/oads/a4.1", required = true)
    protected PersonRef submittedBy;
    @XmlElement(name = "submission_date", namespace = "http://ncei.noaa.gov/oads/a4.1", required = true)
