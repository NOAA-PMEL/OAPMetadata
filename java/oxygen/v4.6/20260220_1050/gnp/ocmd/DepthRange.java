 ...
 *       &lt;sequence&gt;
 *         &lt;element name="min_depth" type="{https://ncei.noaa.gov/ocads/v4.6}depth_m"/&gt;
 *         &lt;element name="max_depth" type="{https://ncei.noaa.gov/ocads/v4.6}depth_m"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "depth_range", namespace = "https://ncei.noaa.gov/ocads/v4.6", propOrder = {
    "minDepth",
    "maxDepth"
})
public class DepthRange {

    @XmlElement(name = "min_depth", namespace = "https://ncei.noaa.gov/ocads/v4.6", required = true)
    protected DepthM minDepth;
    @XmlElement(name = "max_depth", namespace = "https://ncei.noaa.gov/ocads/v4.6", required = true)
