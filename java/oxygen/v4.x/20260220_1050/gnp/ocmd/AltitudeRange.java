 ...
 *       &lt;sequence&gt;
 *         &lt;element name="min_altitude" type="{https://ncei.noaa.gov/ocads/v4.6}altitude_m"/&gt;
 *         &lt;element name="max_altitude" type="{https://ncei.noaa.gov/ocads/v4.6}altitude_m"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "altitude_range", namespace = "https://ncei.noaa.gov/ocads/v4.6", propOrder = {
    "minAltitude",
    "maxAltitude"
})
public class AltitudeRange {

    @XmlElement(name = "min_altitude", namespace = "https://ncei.noaa.gov/ocads/v4.6", required = true)
    protected AltitudeM minAltitude;
    @XmlElement(name = "max_altitude", namespace = "https://ncei.noaa.gov/ocads/v4.6", required = true)
