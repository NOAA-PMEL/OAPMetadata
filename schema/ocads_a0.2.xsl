...
<xsl:stylesheet version="2.0" xmlns:oa="http://ncei.noaa.gov/oads_metadata" 
...
.val {
      ...
      <body >
        ...
        <div>
          ...
          <xsl:for-each select="oa:investigators/oa:investigator">
            ...
            <div style="width:900px; margin-left: 30px; text-indent:-20px;">
              ...
              <xsl:if test="oa:contactInfo/oa:address/oa:deliveryPoint != ''">
                <xsl:value-of select="oa:contactInfo/oa:deliveryPoint"/>,
              </xsl:if>
          ...
          <xsl:if test="oa:useLimitation != ''">
            <span style="font-weight:bold">FAIR USE STATEMENT (from data producers): </span><xsl:value-of select="oa:useLimitation"/>
            <br/><br/>
          </xsl:if>
          ...
          <xsl:if test="oa:cruiseIdentifiers/oa:expocode != ''">
            <xsl:for-each select="oa:cruiseIdentifiers/oa:expocode">
              <xsl:apply-templates/>;
            </xsl:for-each>
          </xsl:if>
          </div>
          ...
          <xsl:if test="oa:cruiseIdentifiers/oa:cruiseId != ''">
            <xsl:for-each select="oa:cruiseIdentifiers/oa:cruiseId">
              <xsl:apply-templates/>;
            </xsl:for-each>
          </xsl:if>
          </div>
            ...
            <tr><td style="width: 450px;">
              <table style="padding-left:0px; width:430px">
                ...
                <span style="padding-left:20px;"></span>
                  ...
                  <span style="padding-left:5px;"><xsl:value-of select="."/>;</span>  <!-- <xsl:apply-templates/> -->
                  <br/>
                </xsl:for-each>
                <br/>
              </table>
                ...
                <table style="padding-left:20px; width:500px">
                  <tr>
                    <td style="padding-left:110px; text-align:left;">NORTH BOUNDARY: 
                      <xsl:value-of select="oa:geospatialExtents/oa:northernBounds"/></td>
                  </tr>
                </table>
                ...
                <table style="padding-left:20px; width:500px">
                  <tr>
                    <td style="width: 50%; text-align:left;">WEST BOUNDARY: 
                      <xsl:value-of select="oa:geospatialExtents/oa:westernBounds"/></td>
                    <td style="width: 50%; text-align:left;">EAST BOUNDARY: 
                      <xsl:value-of select="oa:geospatialExtents/oa:easternBounds"/></td>
                  </tr>
                </table>
                <table style="padding-left:20px; width:500px">
                  <tr>
                    <td style="padding-left:110px; text-align:left;">SOUTH BOUNDARY: 
                      <xsl:value-of select="oa:geospatialExtents/oa:southernBounds"/></td>
                  </tr>
                  </table><br/>
                      ...
                      <xsl:if test="oa:platforms/oa:platform != ''">
                        ...
                        <xsl:if test="oa:researchProjects/oa:project != ''">
                          ...
                          <xsl:for-each select="oa:researchProjects/oa:project">
                            <xsl:value-of select="oa:organization"/> : <xsl:value-of select="oa:title"/><br/>
                          </xsl:for-each>
                        </xsl:if>
          ...
          <ul>
          <xsl:for-each select="oa:fundingInformation/oa:fundingSource">
            <li>
            </li>
  ...
  <xsl:template name="variables" match="oa:variables">
          ...
          <xsl:for-each select="oa:variable[@xsi:type='dic_sample_type']|oa:dic">
          ...
          <xsl:for-each select="oa:variable[@xsi:type='ta_sample_type']|oa:ta">
            ...
            <table width="940">
              ...
              <xsl:if test="oa:units != ''"><tr>
                <td class="desc">Units: </td>
                <td class="val"><xsl:value-of select="oa:unit"/></td>
              </tr></xsl:if>
          ...
          <xsl:for-each select="oa:variable[@xsi:type='ph_sample_type']|oa:pH">
            <hr/>
          ...
          <xsl:for-each select="oa:variable[@xsi:type='co2d_sample_type']|oa:co2d">
            <hr/>
          ...
          <xsl:for-each select="variable[@xsi:type='co2a_sample_type']|co2a">
          ...
          <xsl:for-each select="oa:variable[@xsi:type='measured']|oa:measured">
